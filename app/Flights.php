		...
		<div id="distenation">
			...
			<table class="table table-hover">
				...
				<div class='SearchFieldset'>
				  				<input type='text' id='SearchFrom' class="input-medium search-query"  placeholder='Search From'/ >
								<input type='text' id='SearchTo' class="input-medium search-query" placeholder='Search To' />
